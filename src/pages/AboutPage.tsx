                ...
                <div className="flex-grow w-full max-w-screen-xl mx-auto p-6">
                    <div className="max-w-lg">
                        ...
                        <p className="mb-2">
                            ...
                            AutoScout24 (the largest online car marketplace in Europe). There over 10 million users see
                            and use my work every month. I work on basically everything: frontend, backend, cloud-things
                            and sometimes ads and data analytics stuff.
                        </p>
                        <p className="mb-2">
                            Besides my day-to-day work I also I have a lot of side and fun projects. Of course most of
                            them never see the light of day. To see a few of them please see my{' '}
